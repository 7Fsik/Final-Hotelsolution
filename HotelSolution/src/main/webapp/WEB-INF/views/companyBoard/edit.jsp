...
<div id="wrap">
    ...
    <div id="mainboard">
        <div class="write-container">
            <form action="${root}/board/edit?no=${companyBoardVo.no}" method="post">
                ...
                <div class="input-group mb-3">
                    <label for="write-title"></label><input id="write-title" type="text" class="form-control" name="title" placeholder="제목을 입력해주세요 ㅎㅎ" value="${companyBoardVo.title}">
                </div>
